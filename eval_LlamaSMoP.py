...
from scripts.lightning_LlamaSMoP import ModelModule_LLM
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default= 4,
        type= int,
        help= "The total number of projectors in MoP."
    )
    parser.add_argument(
        "--MoP-topk",
        default= 2,
        type= int,
        help= "The number of activated projectors in MoP-top-k."
    )
    parser.add_argument(
        "--apply-load-balancing-loss",
        default= False,
        type= bool,
        help= "Whether to apply the load balancing loss to the MoP-top-k router."
    )
    parser.add_argument(
